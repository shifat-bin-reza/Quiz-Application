    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ico_cross.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Programming.this, MainActivity2.class);
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(view.getId() == R.id.submit_btn){
                    if(rb8.isChecked()){
                        count++;
                        rb8.setBackgroundColor(Color.GREEN);
                        ...
                        if(rb6.isChecked()){
                            ...
                            ans2.setText("Answer: Wrong! Correct answer is: D");
                ...
                if(view.getId() == R.id.submit_btn){
                    if(rb9.isChecked()){
                        ...
                        if(rb10.isChecked()){
                            ...
                            ans3.setText("Answer: Wrong! Correct answer is: A");
                ...
                if(view.getId() == R.id.submit_btn){
                    if(rb15.isChecked()){
                        count++;
                        rb15.setBackgroundColor(Color.GREEN);
                        ...
                        if(rb13.isChecked()){
                            ...
                            ans4.setText("Answer: Wrong! Correct answer is: C");
                ...
                if(view.getId() == R.id.submit_btn){
                    if(rb17.isChecked()){
                        ...
                        if(rb19.isChecked()){
                            ...
                            ans5.setText("Answer: Wrong! Correct answer is: A");
